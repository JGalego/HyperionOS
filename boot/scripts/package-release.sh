...
echo "physical device. Writing hyperion-x86_64-$VERSION.img to a real USB drive (dd if=... of=/dev/sdX)"
echo "needs its own explicit confirmation of the exact target device before running, every time."
