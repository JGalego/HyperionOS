...
/// `hyperion-knowledge-graph`'s own crate doc); everything else falls back to a handful of common
/// human-facing keys, then a truncated raw value as a last, honest resort.
